  ...
  Widget build(BuildContext context) {
    return Consumer<ThemeService>(builder: (context, theme, child) {
      return Stack(children: [
        //layout of image
        isDirectionRTL(context) || AppLocalizations.of(context)?.locale.languageCode == "ar" ||
      AppLocalizations.of(context)?.locale.languageCode == "fa"
        ...
        CouponWidget().offerText(context, data).paddingOnly(
            right: isDirectionRTL(context) || AppLocalizations.of(context)?.locale.languageCode == "ar" ||
      AppLocalizations.of(context)?.locale.languageCode == "fa"
                ? MediaQuery.of(context).size.width * 0.012
                : Sizes.s0,
            left: isDirectionRTL(context) || AppLocalizations.of(context)?.locale.languageCode == "ar" ||
      AppLocalizations.of(context)?.locale.languageCode == "fa"
                ? Sizes.s0
