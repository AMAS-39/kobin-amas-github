        ...
        return DefaultTabController(
          ...
          child: Container(
            ...
            child: TabBar(
              ...
              //list dashboard list
              tabs: appArray.dashboardList.asMap().entries.map(
              ...
              overlayColor: MaterialStateProperty.resolveWith<Color>(
                (Set<MaterialState> states) {
                  ...
                  return appColor(context).appTheme.lightText.withOpacity(0.5);
                },
              ),
              unselectedLabelColor: appColor(context).appTheme.textColor,
              isScrollable: false,
              ...
              indicatorPadding:
                  const EdgeInsets.only(left: Insets.i22, right: Insets.i22),
            ),
          ),
        );
      },
