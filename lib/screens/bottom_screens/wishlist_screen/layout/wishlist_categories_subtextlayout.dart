...
class WishlistCategoriesTextSubLayout extends StatelessWidget {
  final int index;
  final dynamic data;

  const WishlistCategoriesTextSubLayout(
      {super.key, required this.index, this.data});
      ...
      return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Container(
          ...
          child: Text(
            ...
            style:
                appCss.dmPoppinsMedium14.textColor(isThemeColorReturn(context)),
