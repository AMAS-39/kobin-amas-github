...
class AppRoute {
  Map<String, Widget Function(BuildContext)> route = {
    ...
    routeName.categoryView: (p0) => const DepartmentScreen(),
    ...
    routeName.productData: (p0) => ProductsScreen(
          title: '',
        ),
    ...
    routeName.detailsScreen: (p0) => DetailsScreen(
          product: "",
        ),
    routeName.detailsScreenSecond: (p0) => SecondDetailsScreen(product_id: 1),
    ...
    routeName.reviews: (p0) => ReviewScreen(
          product: null,
        )
  };
}
