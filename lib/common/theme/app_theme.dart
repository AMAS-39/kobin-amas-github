  ...
  factory AppTheme.fromType(ThemeType t) {
    switch (t) {
      case ThemeType.light:
        return AppTheme(
          isDark: false,
          backGroundColorMain: const Color(0xffEFEFEF),
          primaryColor: const Color(0xff695467),
          btnPrimaryColor: const Color(0xffA2588F),
          lightText: const Color(0xffA2588F),
          searchBackground: const Color(0xffFFFFFF),
          colorContainer: const Color(0xffD6E0E6),
          backGroundColor: const Color(0xff695467),
          linkErrorColor: const Color(0xffF04949),
          colorText: const Color(0xff9CABB4),
          whiteColor: const Color(0xffFFFFFF),
          highLight: const Color(0xff198754),
          highLightRed: const Color(0xffFF4C3B),
          transparentColor: Color.fromARGB(255, 104, 78, 101),
