  ...
  Widget build(BuildContext context) {
    return Consumer<FilterProvider>(builder: (context1, filter, child) {
      ...
      return GestureDetector(
        onTap: () => filter.isCheckBoxDimension(currentItem['subtitle']),
        child: Row(children: [
          CheckBoxCommon(
                  isCheck: filter.selectedDimension
                      .contains(currentItem['subtitle']),
                  onTap: () =>
                      filter.isCheckBoxDimension(currentItem['subtitle']))
              .paddingOnly(right: Insets.i20, left: Insets.i20),
          Expanded(
            flex: 3,
            child: Text(language(context, currentItem['subtitle'].toString()),
